...
const HERO_PHOTOS: readonly HeroPhoto[] = [
  ...
  },
  {
    ...
    altKey: 'segurosV2.hero.image.empresarial.alt',
    chipKey: 'segurosV2.hero.chip.empresarial',
            ...
            <div className="mt-6 md:mt-8 flex flex-wrap items-center gap-3">
              <WhatsAppCTA
                href={formatWhatsAppLink(
                  ...
                  t('segurosV2.hero.wa.message'),
                )}
                label={t('segurosV2.hero.cta.wa')}
              />
            </div>
          </Reveal>
