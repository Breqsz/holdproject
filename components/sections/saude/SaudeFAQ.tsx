...
const FAQ_CONFIG: FAQConfig[] = [
  { id: 1, blocks: ['p', 'h4', 'p', 'h4', 'p', 'h4', 'p', 'p', 'ul', 'p'] },
  { id: 2, blocks: ['p', 'p', 'ul', 'p'] },
  { id: 3, blocks: ['p', 'ul', 'p', 'p', 'ul'] },
  { id: 4, blocks: ['p', 'ul', 'p', 'p'] },
  { id: 5, blocks: ['p', 'p', 'ul', 'p', 'ul'] },
  { id: 6, blocks: ['p', 'ul', 'p', 'ul', 'p'] },
  { id: 7, blocks: ['p', 'p', 'ul', 'p', 'p'] },
  {
    id: 8,
    blocks: [
      'p', 'h4', 'p', 'h4', 'p', 'ul', 'h4', 'p', 'p', 'h4', 'p', 'ul',
      'h4', 'p', 'p', 'ul', 'h4', 'p', 'ul', 'p', 'h4', 'p', 'ul', 'p',
    ],
  },
  { id: 9, blocks: ['p', 'ul', 'p', 'ul'] },
  { id: 10, blocks: ['p', 'ul', 'p'] },
]
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          {FAQ_CONFIG.map((item, index) => {
            ...
            const question = t(`saudeV2.faq.q${item.id}.q`)
            return (
                    ...
                    >
                      <div className="pb-6 pr-8">
                        {item.blocks.map((type, i) =>
                          renderBlock(type, t(`saudeV2.faq.q${item.id}.b${i + 1}`), i)
                        )}
                      </div>
                    </motion.div>
                  )}
